...
env.new("drift", "Drift")
env.new("sbend", "Bend", length=0, angle=0, k0=0)
env.new("sextupole", "Sextupole")
env.new("rfcavity", "Cavity")
env.new("marker", "Marker")
env.new("rbend", "RBend", length=0, angle=0, k0=0, length_straight=0)
env.new("multipole", "Multipole", knl=[0,0,0,0,0,0])

# Elements of type: quadrupole
env.new("qd1a", "quadrupole", k1="kqd1", length="len_qd1", extra={})
...
env.new("qfs0a", "quadrupole", k1="kqfs0", length="len_qf2", extra={})
env.new("qds0a", "quadrupole", length="len_qd3", k1="kqds0", extra={})
...
env.new("qdm4l", "quadrupole", length="len_qd5", k1="kqdm4l", extra={})
env.new("qfm5l", "quadrupole", k1="kqfm5l", length="len_qf4", extra={})
env.new("qdm6l", "quadrupole", length="len_qd5", k1="kqdm6l", extra={})
env.new("qfm7l", "quadrupole", length="len_qd5", k1="kqfm7l", extra={})
...
env.new("qfm1r", "quadrupole", k1="kqfm1r", length="len_qf4", extra={})
...
env.new("qf13l", "quadrupole", k1="kqf13l", length="lq3", extra={})
env.new("qx0l", "quadrupole", k1="kqx00l", length="lq3", extra={})
env.new("qx1l", "quadrupole", k1="kqx01l", length="lq2", extra={})
env.new("qx2l", "quadrupole", length="(lq2 / 2.0)", k1="kqx02l", extra={})
...
env.new("qd4l", "quadrupole", k1="kqd04l", length="lq3", extra={})
...
env.new("qd0bl", "quadrupole", k1="kqd0bl", length=1.75, extra={})
...
env.new("qf15r", "quadrupole", length="lq2", k1="kqf15r", extra={})
...
env.new("qx1r", "quadrupole", length="lq2", k1="kqx01r", extra={})
...
env.new("qy4r", "quadrupole", length="(lq2 / 2.0)", k1="kqy04r", extra={})
...
env.new("dl1a", "sbend", length="(dl_len * (1.0 + byfr))", angle="(ang0 * (1.0 + byfr))", k0=8.97808e-05, extra={})
env.new("dl2a", "sbend", length="(dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))", k0=8.97808e-05, angle="(ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))", extra={})
env.new("dl3a", "sbend", angle="(ang0 * (1.0 + bxfr))", k0=8.97808e-05, length="(dl_len * (1.0 + bxfr))", extra={})
env.new("ds1a", "sbend", k0=8.97808e-05, angle="((ang0 * bxyff) * ads1)", length="((dl_len * bxyff) * ads1)", extra={})
env.new("ds2a", "sbend", angle="((ang0 * bxyff) * ads2)", k0=8.97808e-05, length="((dl_len * bxyff) * ads2)", extra={})
env.new("ds3a", "sbend", length="((dl_len * bxyff) * ads3)", angle="((ang0 * bxyff) * ads3)", k0=8.97808e-05, extra={})
env.new("ds4a", "sbend", length="((dl_len * bxyff) * (((2.0 - ads1) - ads2) - ads3))", angle="((ang0 * bxyff) * (((2.0 - ads1) - ads2) - ads3))", k0=8.97808e-05, extra={})
env.new("df2a", "sbend", angle="((ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))", length="((dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))", k0=8.97808e-05, extra={})
env.new("df3a", "sbend", angle="((ang0 * (1.0 + bxfr)) * (0.5 + adf1))", k0=8.97808e-05, length="((dl_len * (1.0 + bxfr)) * (0.5 + adf1))", extra={})
env.new("ds1l", "sbend", angle="angs1l", k0=-0, length=7.9, extra={})
env.new("ds1r", "sbend", angle="(-angs1l)", length=7.9, extra={})
...
env.new("sf3a", "sextupole", k2="ksf3", length="lfsxt", extra={})
...
env.new("sf2aul", "sextupole", k2="ksf2ul", length="lfsxt", extra={})
...
env.new("sd2al2", "sextupole", k2="ksd2al2", length="ldsxt", extra={})
env.new("sd2bl2", "sextupole", length="ldsxt", k2="ksd2bl2", extra={})
...
env.new("sd1al3", "sextupole", length="ldsxt", k2="ksd1al3", extra={})
env.new("sf1al3", "sextupole", length="lfsxt", k2="ksf1al3", extra={})
env.new("sd2al3", "sextupole", length="ldsxt", k2="ksd2al3", extra={})
...
env.new("sd1asl", "sextupole", length="ldsxt", k2="ksd1sl", extra={})
env.new("sf1asl", "sextupole", k2="ksf1sl", length="lfsxt", extra={})
env.new("sd2asl", "sextupole", k2="ksd2sl", length="ldsxt", extra={})
...
env.new("sdy2l", "sextupole", length="(l_sxtd / 4.0)", k2="ksdy1l", extra={})
env.new("sdy1l", "sextupole", length="(l_sxtd / 4.0)", k2="ksdy1l", extra={})
env.new("sdm1l", "sextupole", length="(l_sxtm / 2.0)", k2="ksdm1l", extra={})
...
env.new("b7l", "rbend", length_straight="(lbfl * 0.72)", k0=0.000102445, angle="((angffl * b7fl) * 0.72)", length=40.2336, extra={})
env.new("b6l", "rbend", length_straight="(lbfl * 0.72)", angle="((angffl * b6fl) * 0.72)", k0=0.000121155, length=40.2336, extra={})
env.new("b5l", "rbend", k0=0.000117935, length=44.7041, length_straight="(lbfl * 0.8)", angle="((angffl * b5fl) * 0.8)", extra={})
env.new("b4lc", "rbend", length=54.7624, length_straight="(lbfl * 0.98)", k0=2.52682e-05, angle="((angffl * b4fl) * 0.98)", extra={})
env.new("b4lb", "rbend", length=54.7624, length_straight="(lbfl * 0.98)", k0=2.52682e-05, angle="((angffl * b4fl) * 0.98)", extra={})
env.new("b4la", "rbend", length_straight="(lbfl * 1.16)", k0=2.98427e-05, length=64.8208, angle="((angffl * b4fl) * 1.37)", extra={})
env.new("b3l", "rbend", length=39.6748, angle="((angffl * b3fl) * 0.71)", k0=6.57587e-05, length_straight="(lbfl * 0.71)", extra={})
env.new("b1lb", "rbend", angle="((angffl * b1fl) * 1.68)", k0=3.082e-05, length_straight="(lbfl * 1.68)", length=93.8784, extra={})
env.new("b1la", "rbend", length=77.1144, length_straight="(lbfl * 1.38)", angle="((angffl * b0fl) * 1.38)", k0=9.98751e-06, extra={})
env.new("b0l", "rbend", k0=9.98751e-06, length_straight="(lbfl * 1.1)", angle="((angffl * b0fl) * 1.1)", length=61.468, extra={})
env.new("bsl", "rbend", angle="((angffl * b0fl) * 0.76)", k0=9.98751e-06, length=42.4688, length_straight="(lbfl * 0.76)", extra={})
env.new("b7r", "rbend", k0=7.25401e-05, length_straight="(lbfr * 0.84)", angle="((angffr * b7fr) * 0.84)", length=52.038, extra={})
env.new("b6r", "rbend", angle="((angffr * b6fr) * 0.84)", length_straight="(lbfr * 0.84)", k0=0.000124668, length=52.0381, extra={})
env.new("b5rb", "rbend", k0=0.000114615, length_straight="(lbfr * 0.84)", angle="((angffr * b5fr) * 0.94)", length=52.0381, extra={})
env.new("b5ra", "rbend", angle="((angffr * b5fr) * 0.74)", k0=9.02286e-05, length=52.038, length_straight="(lbfr * 0.84)", extra={})
env.new("b4rb", "rbend", length=47.082, length_straight="(lbfr * 0.76)", angle="((angffr * b4fr) * 0.66)", k0=3.03918e-05, extra={})
env.new("b4ra", "rbend", length=47.082, length_straight="(lbfr * 0.76)", angle="((angffr * b4fr) * 0.86)", k0=3.96015e-05, extra={})
env.new("b3r", "rbend", length_straight="(lbfr * 0.665)", length=41.1968, angle="((angffr * b3fr) * 0.665)", k0=8.37768e-05, extra={})
env.new("b1rb", "rbend", k0=8.37767e-05, angle="((angffr * b1fr) * 0.749)", length_straight="(lbfr * 0.749)", length=46.4006, extra={})
env.new("b1ra", "rbend", k0=8.37768e-05, length_straight="(lbfr * 0.547)", angle="((angffr * b1fr) * 0.547)", length=33.8867, extra={})
env.new("b0r", "rbend", angle="((angffr * b0fr) * 0.423)", k0=9.89876e-05, length_straight="(lbfr * 0.358)", length=22.1781, extra={})
env.new("bsr", "rbend", angle="((angffr * b0fr) * 0.423)", k0=9.89876e-05, length_straight="(lbfr * 0.358)", length=22.1781, extra={})

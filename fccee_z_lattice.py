...
# sbend elements:
env.new('dl1a', 'sbend', length='(dl_len * (1.0 + byfr))', angle='(ang0 * (1.0 + byfr))', k0_from_h=True)
env.new('dl2a', 'sbend', length='(dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))', angle='(ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))', k0_from_h=True)
env.new('dl3a', 'sbend', length='(dl_len * (1.0 + bxfr))', angle='(ang0 * (1.0 + bxfr))', k0_from_h=True)
env.new('df2a', 'sbend', length='((dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))', angle='((ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))', k0_from_h=True)
env.new('df3a', 'sbend', length='((dl_len * (1.0 + bxfr)) * (0.5 + adf1))', angle='((ang0 * (1.0 + bxfr)) * (0.5 + adf1))', k0_from_h=True)
env.new('ds1a', 'sbend', length='((dl_len * bxyff) * ads1)', angle='((ang0 * bxyff) * ads1)', k0_from_h=True)
env.new('ds2a', 'sbend', length='((dl_len * bxyff) * ads2)', angle='((ang0 * bxyff) * ads2)', k0_from_h=True)
env.new('ds3a', 'sbend', length='((dl_len * bxyff) * ads3)', angle='((ang0 * bxyff) * ads3)', k0_from_h=True)
env.new('ds4a', 'sbend', length='((dl_len * bxyff) * (((2.0 - ads1) - ads2) - ads3))', angle='((ang0 * bxyff) * (((2.0 - ads1) - ads2) - ads3))', k0_from_h=True)
env.new('ds1l', 'sbend', length=7.9, angle='angs1l', k0_from_h=True)
env.new('ds1r', 'sbend', length=7.9, angle='-angs1l', k0_from_h=True)

# rbend elements:
env.new('b7l', 'rbend', angle='((angffl * b7fl) * 0.72)', length_straight='(lbfl * 0.72)', k0_from_h=True)
env.new('b6l', 'rbend', angle='((angffl * b6fl) * 0.72)', length_straight='(lbfl * 0.72)', k0_from_h=True)
env.new('b5l', 'rbend', angle='((angffl * b5fl) * 0.8)', length_straight='(lbfl * 0.8)', k0_from_h=True)
env.new('b4lc', 'rbend', angle='((angffl * b4fl) * 0.98)', length_straight='(lbfl * 0.98)', k0_from_h=True)
env.new('b4lb', 'rbend', angle='((angffl * b4fl) * 0.98)', length_straight='(lbfl * 0.98)', k0_from_h=True)
env.new('b4la', 'rbend', angle='((angffl * b4fl) * 1.37)', length_straight='(lbfl * 1.16)', k0_from_h=True)
env.new('b3l', 'rbend', angle='((angffl * b3fl) * 0.71)', length_straight='(lbfl * 0.71)', k0_from_h=True)
env.new('b1lb', 'rbend', angle='((angffl * b1fl) * 1.68)', length_straight='(lbfl * 1.68)', k0_from_h=True)
env.new('b1la', 'rbend', angle='((angffl * b0fl) * 1.38)', length_straight='(lbfl * 1.38)', k0_from_h=True)
env.new('b0l', 'rbend', angle='((angffl * b0fl) * 1.1)', length_straight='(lbfl * 1.1)', k0_from_h=True)
env.new('bsl', 'rbend', angle='((angffl * b0fl) * 0.76)', length_straight='(lbfl * 0.76)', k0_from_h=True)
env.new('b7r', 'rbend', angle='((angffr * b7fr) * 0.84)', length_straight='(lbfr * 0.84)', k0_from_h=True)
env.new('b6r', 'rbend', angle='((angffr * b6fr) * 0.84)', length_straight='(lbfr * 0.84)', k0_from_h=True)
env.new('b5rb', 'rbend', angle='((angffr * b5fr) * 0.94)', length_straight='(lbfr * 0.84)', k0_from_h=True)
env.new('b5ra', 'rbend', angle='((angffr * b5fr) * 0.74)', length_straight='(lbfr * 0.84)', k0_from_h=True)
env.new('b4rb', 'rbend', angle='((angffr * b4fr) * 0.66)', length_straight='(lbfr * 0.76)', k0_from_h=True)
env.new('b4ra', 'rbend', angle='((angffr * b4fr) * 0.86)', length_straight='(lbfr * 0.76)', k0_from_h=True)
env.new('b3r', 'rbend', angle='((angffr * b3fr) * 0.665)', length_straight='(lbfr * 0.665)', k0_from_h=True)
env.new('b1rb', 'rbend', angle='((angffr * b1fr) * 0.749)', length_straight='(lbfr * 0.749)', k0_from_h=True)
env.new('b1ra', 'rbend', angle='((angffr * b1fr) * 0.547)', length_straight='(lbfr * 0.547)', k0_from_h=True)
env.new('b0r', 'rbend', angle='((angffr * b0fr) * 0.423)', length_straight='(lbfr * 0.358)', k0_from_h=True)
env.new('bsr', 'rbend', angle='((angffr * b0fr) * 0.423)', length_straight='(lbfr * 0.358)', k0_from_h=True)

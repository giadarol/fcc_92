...
env.new("quadrupole", "Quadrupole", _model=0, _integrator=0)
env.new("drift", "Drift")
env.new("sbend", "Bend", inv_factorial_order=0.00833333, _integrator=0, _order=5, length=0, k0_from_h=0, angle=0)
env.new("sextupole", "Sextupole", _model=0, _integrator=0)
env.new("rfcavity", "Cavity")
env.new("marker", "Marker")
env.new("rbend", "RBend", inv_factorial_order=0.00833333, _integrator=0, _order=5, length=0, k0_from_h=0, angle=0, length_straight=0)
...
env.new("qd3a", "quadrupole", length="len_qd3", k1="kqd3", extra={})
env.new("qf4a", "quadrupole", k1="kqf4", length="len_qf4", extra={})
env.new("qd5a", "quadrupole", k1="kqd5", length="len_qd5", extra={})
env.new("qf6a", "quadrupole", k1="kqf6", length="len_qf6", extra={})
env.new("qfs0a", "quadrupole", length="len_qf2", k1="kqfs0", extra={})
env.new("qds0a", "quadrupole", k1="kqds0", length="len_qd3", extra={})
env.new("qfs1a", "quadrupole", k1="kqfs1", length="len_qf4", extra={})
env.new("qds2a", "quadrupole", k1="kqds2", length="len_qd5", extra={})
env.new("qfs3a", "quadrupole", k1="kqfs3", length="len_qf6", extra={})
env.new("qds4a", "quadrupole", k1="kqds4", length="len_qd5", extra={})
env.new("qfs5a", "quadrupole", length="len_qf4", k1="kqfs5", extra={})
env.new("qfm0l", "quadrupole", k1="kqfm0l", length="len_qf2", extra={})
env.new("qdm0l", "quadrupole", k1="kqdm0l", length="len_qd3", extra={})
env.new("qfm1l", "quadrupole", length="len_qf4", k1="kqfm1l", extra={})
env.new("qdm2l", "quadrupole", k1="kqdm2l", length="len_qd5", extra={})
env.new("qfm3l", "quadrupole", k1="kqfm3l", length="len_qf6", extra={})
env.new("qdm4l", "quadrupole", k1="kqdm4l", length="len_qd5", extra={})
env.new("qfm5l", "quadrupole", length="len_qf4", k1="kqfm5l", extra={})
env.new("qdm6l", "quadrupole", k1="kqdm6l", length="len_qd5", extra={})
env.new("qfm7l", "quadrupole", k1="kqfm7l", length="len_qd5", extra={})
env.new("qdm8l", "quadrupole", k1="kqdm8l", length="len_qd5", extra={})
env.new("qfm0r", "quadrupole", k1="kqfm0r", length="len_qf2", extra={})
env.new("qdm0r", "quadrupole", k1="kqdm0r", length="len_qd3", extra={})
env.new("qfm1r", "quadrupole", length="len_qf4", k1="kqfm1r", extra={})
env.new("qdm2r", "quadrupole", k1="kqdm2r", length="len_qd5", extra={})
env.new("qfm3r", "quadrupole", k1="kqfm3r", length="len_qf6", extra={})
env.new("qdm4r", "quadrupole", k1="kqdm4r", length="len_qd5", extra={})
env.new("qfm5r", "quadrupole", k1="kqfm5r", length="len_qf4", extra={})
env.new("qdm6r", "quadrupole", k1="kqdm6r", length="len_qd5", extra={})
env.new("qfm7r", "quadrupole", k1="kqfm7r", length="len_qd5", extra={})
env.new("qdm8r", "quadrupole", k1="kqdm8r", length="len_qd5", extra={})
...
env.new("qfl3a", "quadrupole", length=1, k1="kqfl3", extra={})
env.new("qdl3a", "quadrupole", length=1, k1="kqdl3", extra={})
env.new("qfl6a", "quadrupole", length=1, k1="kqfl6", extra={})
env.new("qdl4a", "quadrupole", k1="kqdl4", length=1, extra={})
env.new("qfl4a", "quadrupole", length=1, k1="kqfl4", extra={})
env.new("qdl5a", "quadrupole", length=1, k1="kqdl5", extra={})
env.new("qfl5a", "quadrupole", length=1, k1="kqfl5", extra={})
env.new("qdl6a", "quadrupole", length=0.5, k1="kqdl6", extra={})
env.new("qd20l", "quadrupole", k1="kqd20l", length="lq2", extra={})
env.new("qf19l", "quadrupole", length="lq4", k1="kqf19l", extra={})
env.new("qd18l", "quadrupole", length="lq4", k1="kqd18l", extra={})
env.new("qf17l", "quadrupole", length="lq4", k1="kqf17l", extra={})
env.new("qd16l", "quadrupole", k1="kqd16l", length="lq2", extra={})
env.new("qf15l", "quadrupole", length="lq4", k1="kqf15l", extra={})
env.new("qd14l", "quadrupole", k1="kqd14l", length="lq2", extra={})
...
env.new("qy4l", "quadrupole", length="(lq2 / 2.0)", k1="kqy04l", extra={})
env.new("qd6l", "quadrupole", length="lq3", k1="kqd06l", extra={})
env.new("qf5l", "quadrupole", k1="kqf05l", length="lq2", extra={})
env.new("qd4l", "quadrupole", length="lq3", k1="kqd04l", extra={})
env.new("qd2l", "quadrupole", k1="kqd02l", length="lq3", extra={})
env.new("qf2l", "quadrupole", k1="kqf02l", length="lq3", extra={})
env.new("qd1l", "quadrupole", length="lq3", k1="kqd01l", extra={})
env.new("qf1bl", "quadrupole", length=1.5, k1="kqf1bl", extra={})
...
env.new("qf19r", "quadrupole", k1="kqf19r", length="lq2", extra={})
env.new("qd18r", "quadrupole", k1="kqd18r", length="lq2", extra={})
env.new("qf17r", "quadrupole", k1="kqf17r", length="lq2", extra={})
env.new("qd16r", "quadrupole", k1="kqd16r", length="lq2", extra={})
env.new("qf15r", "quadrupole", k1="kqf15r", length="lq2", extra={})
env.new("qd14r", "quadrupole", k1="kqd14r", length="lq2", extra={})
env.new("qf13r", "quadrupole", k1="kqf13r", length="lq3", extra={})
env.new("qx0r", "quadrupole", length="lq3", k1="kqx00r", extra={})
env.new("qx1r", "quadrupole", k1="kqx01r", length="lq2", extra={})
env.new("qx2r", "quadrupole", length="(lq2 / 2.0)", k1="kqx02r", extra={})
env.new("qf12r", "quadrupole", k1="kqf12r", length="lq3", extra={})
...
env.new("qf8r", "quadrupole", k1="kqf08r", length="lq2", extra={})
...
env.new("qf1br", "quadrupole", length=1.5, k1="kqf1br", extra={})
env.new("qf1ar", "quadrupole", length=1.5, k1="kqf1ar", extra={})
env.new("qd0br", "quadrupole", length=1.75, k1="kqd0br", extra={})
env.new("qd0ar", "quadrupole", length=1.75, k1="kqd0ar", extra={})
...
env.new("dl2a", "sbend", k0_from_h=1, angle="(ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))", length="(dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0)))", extra={})
...
env.new("ds4a", "sbend", angle="((ang0 * bxyff) * (((2.0 - ads1) - ads2) - ads3))", k0_from_h=1, length="((dl_len * bxyff) * (((2.0 - ads1) - ads2) - ads3))", extra={})
env.new("df2a", "sbend", angle="((ang0 * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))", k0_from_h=1, length="((dl_len * ((1.0 - (byfr / 3.0)) - (bxfr / 3.0))) * (0.5 + adf1))", extra={})
env.new("df3a", "sbend", k0_from_h=1, angle="((ang0 * (1.0 + bxfr)) * (0.5 + adf1))", length="((dl_len * (1.0 + bxfr)) * (0.5 + adf1))", extra={})
env.new("ds1l", "sbend", k0_from_h=1, length=7.9, angle="angs1l", extra={})
env.new("ds1r", "sbend", k0_from_h=1, angle="(-angs1l)", length=7.9, extra={})

# Elements of type: sextupole
env.new("sf2a", "sextupole", k2="ksf2", length="lfsxt", extra={})
env.new("sd1a", "sextupole", k2="ksd1", length="ldsxt", extra={})
env.new("sf1a", "sextupole", length="lfsxt", k2="ksf1", extra={})
env.new("sd2a", "sextupole", k2="ksd2", length="ldsxt", extra={})
...
env.new("sd2aul", "sextupole", k2="ksd2ul", length="ldsxt", extra={})
env.new("sf1aul", "sextupole", k2="ksf1ul", length="lfsxt", extra={})
env.new("sd1aul", "sextupole", k2="ksd1ul", length="ldsxt", extra={})
env.new("sf2aul", "sextupole", length="lfsxt", k2="ksf2ul", extra={})
env.new("sd2aur", "sextupole", k2="ksd2ur", length="ldsxt", extra={})
env.new("sf1aur", "sextupole", k2="ksf1ur", length="lfsxt", extra={})
env.new("sd1aur", "sextupole", k2="ksd1ur", length="ldsxt", extra={})
env.new("sf2aur", "sextupole", k2="ksf2ur", length="lfsxt", extra={})
env.new("sf2al2", "sextupole", length="lfsxt", k2="ksf2al2", extra={})
env.new("sd1al2", "sextupole", k2="ksd1al2", length="ldsxt", extra={})
env.new("sf1al2", "sextupole", k2="ksf1al2", length="lfsxt", extra={})
env.new("sd2al2", "sextupole", length="ldsxt", k2="ksd2al2", extra={})
env.new("sd2bl2", "sextupole", k2="ksd2bl2", length="ldsxt", extra={})
env.new("sf1bl2", "sextupole", k2="ksf1bl2", length="lfsxt", extra={})
env.new("sd1bl2", "sextupole", k2="ksd1bl2", length="ldsxt", extra={})
env.new("sf2bl2", "sextupole", k2="ksf2bl2", length="lfsxt", extra={})
env.new("sf2al3", "sextupole", k2="ksf2al3", length="lfsxt", extra={})
env.new("sd1al3", "sextupole", k2="ksd1al3", length="ldsxt", extra={})
env.new("sf1al3", "sextupole", k2="ksf1al3", length="lfsxt", extra={})
env.new("sd2al3", "sextupole", k2="ksd2al3", length="ldsxt", extra={})
env.new("sd2bl3", "sextupole", k2="ksd2bl3", length="ldsxt", extra={})
env.new("sf1bl3", "sextupole", k2="ksf1bl3", length="lfsxt", extra={})
env.new("sd1bl3", "sextupole", length="ldsxt", k2="ksd1bl3", extra={})
env.new("sf2bl3", "sextupole", k2="ksf2bl3", length="lfsxt", extra={})
env.new("sf2ar2", "sextupole", k2="ksf2ar2", length="lfsxt", extra={})
env.new("sd1ar2", "sextupole", length="ldsxt", k2="ksd1ar2", extra={})
...
env.new("sf1br2", "sextupole", length="lfsxt", k2="ksf1br2", extra={})
env.new("sd1br2", "sextupole", length="ldsxt", k2="ksd1br2", extra={})
env.new("sf2br2", "sextupole", k2="ksf2br2", length="lfsxt", extra={})
env.new("sf2ar3", "sextupole", k2="ksf2ar3", length="lfsxt", extra={})
env.new("sd1ar3", "sextupole", k2="ksd1ar3", length="ldsxt", extra={})
env.new("sf1ar3", "sextupole", k2="ksf1ar3", length="lfsxt", extra={})
env.new("sd2ar3", "sextupole", length="ldsxt", k2="ksd2ar3", extra={})
env.new("sd2br3", "sextupole", k2="ksd2br3", length="ldsxt", extra={})
env.new("sf1br3", "sextupole", k2="ksf1br3", length="lfsxt", extra={})
env.new("sd1br3", "sextupole", k2="ksd1br3", length="ldsxt", extra={})
env.new("sf2br3", "sextupole", k2="ksf2br3", length="lfsxt", extra={})
env.new("sf2asl", "sextupole", k2="ksf2sl", length="lfsxt", extra={})
...
env.new("sf2asr", "sextupole", k2="ksf2sr", length="lfsxt", extra={})
env.new("sd1asr", "sextupole", length="ldsxt", k2="ksd1sr", extra={})
env.new("sf1asr", "sextupole", k2="ksf1sr", length="lfsxt", extra={})
env.new("sd2asr", "sextupole", length="ldsxt", k2="ksd2sr", extra={})
env.new("sf3asr", "sextupole", k2="ksf3sr", length="lfsxt", extra={})
env.new("sf2afl", "sextupole", length="lfsxt", k2="ksf2fl", extra={})
env.new("sd1afl", "sextupole", k2="ksd1fl", length="ldsxt", extra={})
env.new("sf1afl", "sextupole", length="lfsxt", k2="ksf1fl", extra={})
env.new("sd2afl", "sextupole", k2="ksd2fl", length="ldsxt", extra={})
env.new("sf3afl", "sextupole", k2="ksf3fl", length="lfsxt", extra={})
env.new("scrabl", "sextupole", length="(l_sxtf / 4.0)", k2="kcrabl", extra={})
env.new("sf2afr", "sextupole", k2="ksf2fr", length="lfsxt", extra={})
env.new("sd1afr", "sextupole", k2="ksd1fr", length="ldsxt", extra={})
env.new("sf1afr", "sextupole", k2="ksf1fr", length="lfsxt", extra={})
env.new("sd2afr", "sextupole", k2="ksd2fr", length="ldsxt", extra={})
env.new("sf3afr", "sextupole", k2="ksf3fr", length="lfsxt", extra={})
env.new("scrabr", "sextupole", length="(l_sxtf / 4.0)", k2="kcrabr", extra={})
env.new("sfx2l", "sextupole", length="(l_sxtf / 4.0)", k2="ksfx1l", extra={})
env.new("sfx1l", "sextupole", length="(l_sxtf / 4.0)", k2="ksfx1l", extra={})
...
env.new("sfx2r", "sextupole", length="(l_sxtf / 4.0)", k2="ksfx1r", extra={})
env.new("sfx1r", "sextupole", length="(l_sxtf / 4.0)", k2="ksfx1r", extra={})
env.new("sfm2r", "sextupole", length="(l_sxtm / 2.0)", k2="ksfm2r", extra={})
...
env.new("rfc", "rfcavity", voltage="(rf_voltage * 1000000.0)", frequency="(harmonic_number * f_rev)", lag="(rf_lag * 360)", extra={})
...
env.new("b7l", "rbend", length_straight="(lbfl * 0.72)", k0_from_h=1, length=40.2336, angle="((angffl * b7fl) * 0.72)", extra={})
env.new("b6l", "rbend", length_straight="(lbfl * 0.72)", k0_from_h=1, length=40.2336, angle="((angffl * b6fl) * 0.72)", extra={})
env.new("b5l", "rbend", angle="((angffl * b5fl) * 0.8)", k0_from_h=1, length=44.7041, length_straight="(lbfl * 0.8)", extra={})
env.new("b4lc", "rbend", k0_from_h=1, length_straight="(lbfl * 0.98)", length=54.7624, angle="((angffl * b4fl) * 0.98)", extra={})
env.new("b4lb", "rbend", k0_from_h=1, length_straight="(lbfl * 0.98)", length=54.7624, angle="((angffl * b4fl) * 0.98)", extra={})
env.new("b4la", "rbend", k0_from_h=1, angle="((angffl * b4fl) * 1.37)", length=64.8208, length_straight="(lbfl * 1.16)", extra={})
env.new("b3l", "rbend", k0_from_h=1, length_straight="(lbfl * 0.71)", length=39.6748, angle="((angffl * b3fl) * 0.71)", extra={})
env.new("b1lb", "rbend", k0_from_h=1, length=93.8784, angle="((angffl * b1fl) * 1.68)", length_straight="(lbfl * 1.68)", extra={})
env.new("b1la", "rbend", k0_from_h=1, length=77.1144, angle="((angffl * b0fl) * 1.38)", length_straight="(lbfl * 1.38)", extra={})
env.new("b0l", "rbend", k0_from_h=1, length_straight="(lbfl * 1.1)", angle="((angffl * b0fl) * 1.1)", length=61.468, extra={})
env.new("bsl", "rbend", k0_from_h=1, length_straight="(lbfl * 0.76)", angle="((angffl * b0fl) * 0.76)", length=42.4688, extra={})
env.new("b7r", "rbend", k0_from_h=1, angle="((angffr * b7fr) * 0.84)", length=52.038, length_straight="(lbfr * 0.84)", extra={})
env.new("b6r", "rbend", k0_from_h=1, length=52.0381, angle="((angffr * b6fr) * 0.84)", length_straight="(lbfr * 0.84)", extra={})
env.new("b5rb", "rbend", k0_from_h=1, length=52.0381, angle="((angffr * b5fr) * 0.94)", length_straight="(lbfr * 0.84)", extra={})
env.new("b5ra", "rbend", k0_from_h=1, angle="((angffr * b5fr) * 0.74)", length=52.038, length_straight="(lbfr * 0.84)", extra={})
env.new("b4rb", "rbend", k0_from_h=1, length_straight="(lbfr * 0.76)", length=47.082, angle="((angffr * b4fr) * 0.66)", extra={})
env.new("b4ra", "rbend", k0_from_h=1, length_straight="(lbfr * 0.76)", length=47.082, angle="((angffr * b4fr) * 0.86)", extra={})
env.new("b3r", "rbend", k0_from_h=1, length_straight="(lbfr * 0.665)", length=41.1968, angle="((angffr * b3fr) * 0.665)", extra={})
env.new("b1rb", "rbend", k0_from_h=1, angle="((angffr * b1fr) * 0.749)", length_straight="(lbfr * 0.749)", length=46.4006, extra={})
env.new("b1ra", "rbend", k0_from_h=1, length=33.8867, length_straight="(lbfr * 0.547)", angle="((angffr * b1fr) * 0.547)", extra={})
env.new("b0r", "rbend", k0_from_h=1, angle="((angffr * b0fr) * 0.423)", length=22.1781, length_straight="(lbfr * 0.358)", extra={})
env.new("bsr", "rbend", k0_from_h=1, angle="((angffr * b0fr) * 0.423)", length=22.1781, length_straight="(lbfr * 0.358)", extra={})

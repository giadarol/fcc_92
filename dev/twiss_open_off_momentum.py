...
def twiss_off_momentum(section, delta_range=(-0.02, 0.02), num_delta=21,
...
class ActionOffMom(xt.Action):
    ...
    def __init__(self, section, delta_range=(-0.02, 0.02), num_delta=21,
                          edge_l='ff_edge_l', edge_r='ff_edge_r'):
    ...
    def run(self):
        tw_om = twiss_off_momentum(self.section, self.delta_range, self.num_delta,
                                   self.edge_l, self.edge_r)
        return tw_om
